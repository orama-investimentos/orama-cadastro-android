...
public class UsersApi {
  ...
  * 
   ...
   * @return Submetido
  */
  public Submetido accountPerfilSubmetidoGet (String cpf) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'cpf' is set
    if (cpf == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'cpf' when calling accountPerfilSubmetidoGet",
        new ApiException(400, "Missing the required parameter 'cpf' when calling accountPerfilSubmetidoGet"));
    }

    // create path and map variables
    String path = "/perfil/{cpf}/submetido/".replaceAll("\\{" + "cpf" + "\\}", apiInvoker.escapeString(cpf.toString()));
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (Submetido) ApiInvoker.deserialize(localVarResponse, "", Submetido.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param cpf CPF do perfil
  */
  public void accountPerfilSubmetidoGet (String cpf, final Response.Listener<Submetido> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/perfil/{cpf}/submetido/".replaceAll("\\{format\\}","json").replaceAll("\\{" + "cpf" + "\\}", apiInvoker.escapeString(cpf.toString()));
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((Submetido) ApiInvoker.deserialize(localVarResponse,  "", Submetido.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  * 
   ...
   * @return Confirmado
  */
  public Confirmado accountPerfilTermosConfirmacaoGet (String cpf) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'cpf' is set
    if (cpf == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'cpf' when calling accountPerfilTermosConfirmacaoGet",
        new ApiException(400, "Missing the required parameter 'cpf' when calling accountPerfilTermosConfirmacaoGet"));
    }

    // create path and map variables
    String path = "/perfil/{cpf}/termos/confirmacao/".replaceAll("\\{" + "cpf" + "\\}", apiInvoker.escapeString(cpf.toString()));
   ...
   * @param cpf CPF do perfil
  */
  public void accountPerfilTermosConfirmacaoGet (String cpf, final Response.Listener<Confirmado> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/perfil/{cpf}/termos/confirmacao/".replaceAll("\\{format\\}","json").replaceAll("\\{" + "cpf" + "\\}", apiInvoker.escapeString(cpf.toString()));
  ...
  * 
   ...
   * @return Confirmado
  */
  public Confirmado accountPerfilTermosConfirmacaoPost (String cpf) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'cpf' is set
    if (cpf == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'cpf' when calling accountPerfilTermosConfirmacaoPost",
        new ApiException(400, "Missing the required parameter 'cpf' when calling accountPerfilTermosConfirmacaoPost"));
    }
   ...
   * @param cpf CPF do perfil
  */
  public void accountPerfilTermosConfirmacaoPost (String cpf, final Response.Listener<Confirmado> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * Consulta os termos exigidos para o perfil
   ...
   * @return List<Termos>
  */
  public List<Termos> accountPerfilTermosGet (String cpf) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'cpf' is set
    if (cpf == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'cpf' when calling accountPerfilTermosGet",
        new ApiException(400, "Missing the required parameter 'cpf' when calling accountPerfilTermosGet"));
    }

    // create path and map variables
    String path = "/perfil/{cpf}/termos/".replaceAll("\\{" + "cpf" + "\\}", apiInvoker.escapeString(cpf.toString()));
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (List<Termos>) ApiInvoker.deserialize(localVarResponse, "array", Termos.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param cpf CPF do perfil
  */
  public void accountPerfilTermosGet (String cpf, final Response.Listener<List<Termos>> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/perfil/{cpf}/termos/".replaceAll("\\{format\\}","json").replaceAll("\\{" + "cpf" + "\\}", apiInvoker.escapeString(cpf.toString()));
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((List<Termos>) ApiInvoker.deserialize(localVarResponse,  "array", Termos.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
