...
public class JsonUtil {
  ...
  public static Type getListTypeForDeserialization(Class cls) {
    ...
    if ("Submetido".equalsIgnoreCase(className)) {
      return new TypeToken<List<Submetido>>(){}.getType();
    }
    
    if ("Termos".equalsIgnoreCase(className)) {
      return new TypeToken<List<Termos>>(){}.getType();
    }
  ...
  public static Type getTypeForDeserialization(Class cls) {
    ...
    if ("Submetido".equalsIgnoreCase(className)) {
      return new TypeToken<Submetido>(){}.getType();
    }
    
    if ("Termos".equalsIgnoreCase(className)) {
      return new TypeToken<Termos>(){}.getType();
    }
